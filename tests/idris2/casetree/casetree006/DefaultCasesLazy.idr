...
fullCoverage : Lazy MyBit -> Int
fullCoverage A = 1
fullCoverage B = 2

extraDefault : Lazy MyBit -> Int
extraDefault A = 1
extraDefault B = 2
extraDefault _ = 3

usefulDefault : Lazy MyBit -> Int
usefulDefault A = 1
usefulDefault _ = 2

earlyDefault : Lazy MyBit -> Int
earlyDefault _ = 1
earlyDefault A = 2

onlyDefault : Lazy MyBit -> Int
onlyDefault _ = 1

nestedFullCoverage : Lazy MyBit -> MyBit -> Int
